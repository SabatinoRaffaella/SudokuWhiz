...
public class BoardState {
     ...
     * Restituisce il numero di celle bianche contenute all'interno del parametro
     * grid.
     * 
     ...
     * Restituisce il numero di possibili valori che una cella può assumere
     * all'interno del parametro grid.
     * 
     * @param grid: Matrice di cui si deve calcolare il numero di celle vuote.
    ...
    /**
     * Duplica la tabella di partenza per valutare le diverse alternative proposte
     * dalle
     * diramazioni per raggiungere lo stato obbiettivo.
     * 
     * @return Un duplicato della tabella del sudoku da usare come nuova
     *         diramazione.
     * 
     */
    ...
    /**
     * Genera delle soluzioni candidate considerando le celle vuote nelle righe e
     * nelle colonne,
     * cercando le celle vuote e utilizzando la seconda euristica definita per il
     * problema
     * cerca la cella con il minimo numero di valori assumibili e la seleziona come
     * possibile cella candidata,
     * una volta selezionata controlla quali valori non violano il vincolo
     * isSafe(il valore della cella non deve essere presente nella
     * riga-colonna-sottogriglia) e crea un nuovo
     * individuo calcolandone il costo e aggiungendolo alla lista delle soluzioni
     * candidate.
     * 
